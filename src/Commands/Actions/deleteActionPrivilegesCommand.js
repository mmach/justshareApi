 ...
 * @extends BaseCommand
 */
export default class DeleteActionPrivilegesCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.actionPrivilegesServiceDI.setContext(this.context).delete({ model: this.model, withProject: true })
