 ...
 * @extends BaseCommand
 */
export default class UpsertActionsProjectCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.actionProjectServiceDI.setContext(this.context).upsert({ model: this.model, withProject: true })
