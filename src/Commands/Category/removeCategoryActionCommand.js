 ...
 * 
 * @export
 * @class RemoveCategoryActionCommand
 * @extends BaseCommand
 */
export default class RemoveCategoryActionCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.categoryServiceDI.setContext(this.context).deleteAction({ model: this.model });
