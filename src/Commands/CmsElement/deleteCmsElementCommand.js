 ...
 * @extends BaseCommand
 */
export default class DeleteCmsElementCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.cmsElementsProjectServiceDI.setContext(this.context).delete({ model: this.model });
