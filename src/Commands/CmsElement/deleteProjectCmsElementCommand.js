 ...
 * @extends BaseCommand
 */
export default class DeleteProjectCmsElementCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.cmsElementsProjectServiceDI.setContext(this.context).delete({ model: this.model, withProject: true });
