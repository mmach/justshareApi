 ...
 * @extends BaseCommand
 */
export default class UpsertCmsElementCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.cmsElementsProjectServiceDI.setContext(this.context).upsert({ model: this.model });
