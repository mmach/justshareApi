 ...
 * @extends BaseCommand
 */
export default class DeleteProjectCmsMenuItemCommand extends BaseCommand {
    /**
     ...
     */
    constructor({ logFileInfrastructureDI, projectInfrastructureDI, cmsMenuItemsProjectServiceDI, authInfrastructureDI }) {
    ...
    async action() {
        await this.cmsMenuItemsProjectServiceDI.setContext(this.context).delete({ model: this.model, withProject: true });
