 ...
 * @extends BaseCommand
 */
export default class DeleteProjectCmsMenuItemPrivilegeCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.cmsMenuItemsPrivilegesProjectServiceDI.setContext(this.context).delete({ model: this.model, withProject: true });
