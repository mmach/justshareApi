 ...
 * @extends BaseCommand
 */
export default class UpsertProjectCmsMenuCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.cmsMenuProjectServiceDI.setContext(this.context).upsert({ model: this.model, withProject: true });
