 ...
 * @extends BaseCommand
 */
export default class UpsertProjectCmsMenuItemPrivilegeCommand extends BaseCommand {
    /**
    ...
    constructor({ logFileInfrastructureDI, projectInfrastructureDI, cmsMenuItemsPrivilegesProjectServiceDI, authInfrastructureDI }) {
        ...
        this.cmsMenuItemsPrivilegesProjectServiceDI = cmsMenuItemsPrivilegesProjectServiceDI
    ...
    async action() {
        await this.cmsMenuItemsPrivilegesProjectServiceDI.setContext(this.context).upsert({ model: this.model, withProject: true });
