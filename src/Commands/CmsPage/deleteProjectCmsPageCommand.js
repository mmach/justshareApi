 ...
 * @extends BaseCommand
 */
export default class DeleteProjectCmsPageCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.cmsPageProjectServiceDI.setContext(this.context).delete({ model: this.model, withProject: true });
