 ...
 * @extends BaseCommand
 */
export default class UpsertProjectCmsPagePrivilegeCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.cmsPagePrivilegesProjectServiceDI.setContext(this.context).upsert({ model: this.model, withProject: true });
