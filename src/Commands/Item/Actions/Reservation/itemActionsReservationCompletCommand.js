...
export default class ItemActionsReservationCompleteCommand extends BaseCommand {
  /**
  ...
  async action() {
    ...
    try {
      ...
      let status = await this.statusProjectServiceDI.setContext(this.context).getByToken({ name: StatusesList.COMPLETE })
