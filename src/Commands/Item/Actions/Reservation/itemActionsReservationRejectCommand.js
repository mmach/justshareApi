...
export default class ItemActionsReservationRejectCommand extends BaseCommand {
  /**
  ...
  async action() {
    ...
    try {
      ...
      let status = await this.statusProjectServiceDI.setContext(this.context).getByToken({ name: StatusesList.REJECTED })
