 ...
 * @extends BaseCommand
 */
export default class InsertLanguageToProjectCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.languageProjectServiceDI.setContext(this.context).upsert({ model: this.model, withProject: true });
