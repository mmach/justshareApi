 ...
 * @extends {BaseCommand}
 */
export default class RemoveMailPartCommand extends BaseCommand {
  /**
  ...
  async action() {
    await this.mailPartsServiceDI.setContext(this.context).delete({ model: this.model, withProject: true })
  }
