 ...
 * @extends {BaseCommand}
 */
export default class UpsertMailTypeCommand extends BaseCommand {
  /**
  ...
  async action() {
    await this.mailTypesServiceDI.setContext(this.context).upsert({ model: this.model, withProject: false })
  }
