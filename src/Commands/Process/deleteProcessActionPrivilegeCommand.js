 ...
 * @extends BaseCommand
 */
export default class DeleteProcessActionPrivilegeCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.processServiceDI.setContext(this.context).deleteChainActionPrivilege({ model: this.model, withProject: true });
    }
};
