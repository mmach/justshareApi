 ...
 * @extends BaseCommand
 */
export default class DeleteProcessChainElementCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.processServiceDI.setContext(this.context).deleteChain({ model: this.model, withProject: true });
    }
};
