 ...
 * @extends BaseCommand
 */
export default class DeleteProcessCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.processServiceDI.setContext(this.context).delete({ model: this.model, withProject: true });
    }
};
