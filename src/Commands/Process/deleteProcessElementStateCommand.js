 ...
 * @extends BaseCommand
 */
export default class DeleteProcessElementStateCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.processServiceDI.setContext(this.context).deleteChainState({ model: this.model, withProject: true });
    }
};
