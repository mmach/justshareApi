 ...
 * @extends BaseCommand
 */
export default class UpsertProcessActionPrivilegeCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.processServiceDI.setContext(this.context).upsertChainActionPrivilege({ model: this.model, withProject: true });
    }
};
