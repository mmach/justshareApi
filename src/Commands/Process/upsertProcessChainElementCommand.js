 ...
 * @extends BaseCommand
 */
export default class UpsertProcessChainElementCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.processServiceDI.setContext(this.context).upsertChain({ model: this.model, withProject: true });
    }
};
