 ...
 * @extends BaseCommand
 */
export default class UpsertProcessElementStateCommand extends BaseCommand {
    /**
    ...
    async action() {
        await this.processServiceDI.setContext(this.context).upsertChainState({ model: this.model, withProject: true });
    }
};
