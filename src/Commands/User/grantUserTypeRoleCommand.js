 ...
 * @extends {BaseCommand}
 */
export default class GrantUserTypeRoleCommand extends BaseCommand {
  /**
  ...
  async action() {
    await this.userTypesRolesServiceDI.setContext(this.context).insert({ model: this.model, withProject: true });
  }
}
