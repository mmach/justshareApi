import { CategoryOptionsTypeTemplateDBO } from ".";
import { BaseDBO } from "../../Architecture/Base/baseDBO";
import { TranslationsDBO } from "../translations";

export interface CategoryOptionsTemplateDBO extends BaseDBO {
    id: string;
    co_id?: string;
    cott_id?: string;
    value?: string;
    ...
    cat_opt_type_template?: CategoryOptionsTypeTemplateDBO;
    value_translation?: TranslationsDBO;
}