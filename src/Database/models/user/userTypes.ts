...
import { UserTypesDTO } from "../../../Models/user";

/**
 * Interface for UserTypes instance
 */
export interface UserTypesInstance extends Model<UserTypesDTO>, UserTypesDTO { }

/**
 * UserTypes model initialization
 */
export default class UserTypes extends Model<UserTypesInstance, UserTypesDTO> {
