...
import { ConversationMessagesDBO } from "../../DBO/conversation/conversationMessages";
/**
 * Interface for ConversationMessages instance
 */
interface ConversationMessagesInstance extends Model<ConversationMessagesDBO>, ConversationMessagesDBO { }

/**
 * ConversationMessages model initialization
 */
export class ConversationMessages extends Model<ConversationMessagesInstance, ConversationMessagesDBO> {
