...
import { ItemUserActionDBO } from "../../DBO/item";
/**
 * Interface for ItemUserAction instance
 */
interface ItemUserActionInstance extends Model<ItemUserActionDBO>, ItemUserActionDBO {}

/**
 * ItemUserAction model initialization
 */
export class ItemUserAction extends Model<ItemUserActionInstance, ItemUserActionDBO> {
