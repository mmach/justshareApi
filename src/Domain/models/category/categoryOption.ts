 ...
 */
interface CategoryOptionInstance extends Model<CategoryOptionDBO>, CategoryOptionDBO {}

/**
 * CategoryOption model initialization
 */
export class CategoryOption extends Model<CategoryOptionInstance, CategoryOptionDBO> {
