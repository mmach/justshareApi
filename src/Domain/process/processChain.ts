...
import { ProcessChainDBO } from "../../DBO/process";
/**
 * Interface for ProcessChain instance
 */
interface ProcessChainInstance extends Model<ProcessChainDBO>, ProcessChainDBO { }

/**
 * ProcessChain model initialization
 */
export class ProcessChain extends Model<ProcessChainInstance, ProcessChainDBO> {
