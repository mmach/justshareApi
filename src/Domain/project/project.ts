...
import { ProjectDBO } from "../../DBO/project";
/**
 * Interface for Project instance
 */
interface ProjectInstance extends Model<ProjectDBO>, ProjectDBO { }

/**
 * Project model initialization
 */
export class Project extends Model<ProjectInstance, ProjectDBO> {
